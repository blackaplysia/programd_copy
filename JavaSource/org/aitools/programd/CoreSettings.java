...
public class CoreSettings extends Settings
{
    ...
    */
    ...
    protected void initialize()
    {
        ...
        setGossipPath(URLTools.contextualize(this.path, this.properties.getProperty("programd.gossip.path", "~/log/programd/gossip.txt")));
        ...
        setMultiplexorFfmDir(URLTools.contextualize(this.path, this.properties.getProperty("programd.multiplexor.ffm-dir", "~/log/programd/ffm")));
